...
import { getRelatedServices, getServiceBySlug } from '@/lib/lib'
...
export default function ServiceDetailPage({
  ...
  const relatedServices = getRelatedServices(service.slug, 3).map(s => ({
    title: s.title,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-3 px-4 py-2 bg-[#D99732]/20 border border-[#D99732] rounded-full mb-6">
                <span className="text-4xl">{service.icon}</span>
                <span className="text-[#D99732] font-semibold uppercase">{service.category}</span>
              </div>
